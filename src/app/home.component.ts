  ...
  template: `
    <div class="home">
      ...
      <ol>
        ...
        <li><s>Beautify the client list</s></li>
        <li><s>Split up the monolith ClientsComponent into smaller components</s></li>
        <li>Consider server-side filtering for name</li>
        <li><s>Add pagination to the client list</s></li>
        <li>Add sorting to the client list</li>
        <li><s>Add tests</s> for the existing components</li>
        ...
        <li>Create an error component to display validation errors</li>
